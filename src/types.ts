...
export type Task = {
  id: string; planKey?: string | null; roomId?: string; room: string; floorId?: string | null; floor: string; floorSort: number; buildingId?: string; building: string; title: string
