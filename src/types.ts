...
export type Task = { id: string; room: string; title: string; frequency: Frequency; assignedTo: string; done: boolean; prerequisite?: string; canComplete?: boolean; dueToday: boolean }
